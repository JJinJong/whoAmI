	...
	<jsp:include page="/app/fix/managementHeader2.jsp" />
               ...
               <div id="main">
                  <div class="inner">
                     ...
                     <!-- Header -->
                        <header id="header">
                           <a href="" class="logo"><strong>전문가 </strong> 목록</a>
                           <ul class="icons">
                           </ul>
                        </header>
                        ...
                        <section>
                           ...
                           <div class="adminsWrapper">
                              <div class="admins">
                                 <div class="adminWrapper">
                                    ...
                                    <div class="admin">
                                       <div class="aContents">   
                                          ...
                                          <div class="expertId">
                                             <a href="" class="expertId">아이디</a>
                                          </div>
								         		   <div class="expertName">
								         		  	   <a href="" class="expertName">이름</a>
								         		   </div>
                                          </div>
                               ...
                               <c:choose>
                                    <c:when test="${managerList != null and fn:length(managerList) > 0}">     
                                    	<div class="admin">
                              ...
                              <tr align="left" valign="middle">
                                 ...
                                 <td class="web-view">
                                    <c:if test="${startPage > 1}">
                                       <a href="${pageContext.request.contextPath}/manager/ManagerListOk.ma?page=${startPage - 1}">&lt;</a>
                                    </c:if>
                                    ...
                                    <c:forEach var="i" begin="${startPage}" end="${endPage}">
                                       <c:choose>
                                          ...
                                          <c:otherwise>
                                             <a href="${pageContext.request.contextPath}/manager/ManagerListOk.ma?page=${i}"><c:out value="${i}"/></a>&nbsp;&nbsp;
                                          </c:otherwise>
                                       </c:choose>
                                    </c:forEach>
                                    
                                    <c:if test="${endPage < realEndPage}">
                                       <a href="${pageContext.request.contextPath}/manager/ManagerListOk.ma?page=${endPage + 1}">&gt;</a>
                                    </c:if>
                                 </td>
                              </tr>
                           </table>
