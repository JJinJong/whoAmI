							...
							<!-- Content -->
								<section class="main">
									...
									<div class="ddcontent">
										...
										2. 소속
										<textarea class="a2">인사팀</textarea>
										3. 직책
										<textarea class="a3">전문가 관리담당</textarea>
										4. 아이디
										<textarea class="a4">yjh</textarea>
										5. 권한
										<div class="radio">
										<!-- <form method="get" action=""> -->
											<input type="radio" name="level" value="최고관리자"><label>최고관리자</label>
											<input type="radio" name="level" value="중간관리자"><label>중간관리자</label>
											<input type="radio" name="level" value="일반관리자"><label>일반관리자</label>
										<!-- </form> -->
										</div>
										6. 비밀번호
