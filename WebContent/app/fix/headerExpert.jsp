			...
			<c:choose>
				<c:when test="${userNumber eq null}"> 
					...
					<button type="button" class="button_join"
						onclick="location.href='${pageContext.request.contextPath }/user/UserJoin.user'">
						회원가입</button>
				</c:when>

				<c:otherwise>
				<button class="button_login" style="padding-right: 20px";> ${userEmail}전문가님 환영합니다</button>
			<c:if test="${userStatus == 1}">
			<button type="button" class="button_expertMyPage"
						onclick="location.href ='${pageContext.request.contextPath}/expertPage/ExpertProflieDetail.ddy'">
						마이페이지</button>
			</c:if>
					<button type="button" class="button_login"
		...
		<div class="header_nav_wrapper">
			...
			<div class="header_nav">
				<div class="header_nav_button_wrapper">
					<button class="header_nav_button" onclick="send()">고민 / 사연</button>
				</div>
				<div class="header_nav_button_wrapper">
					<button class="header_nav_button" onclick="profileCheckSend()">프로필 관리</button>
				</div>

				<div class="header_nav_button_wrapper">
					<button class="header_nav_button" onclick="expertCounselingDetail()">상담내역</button>
				</div>
				
				<div class="header_nav_button_wrapper">
					<button class="header_nav_button" onclick="expertCommentFix()">댓글관리</button>
				</div>
...
<script src="${pageContext.request.contextPath}/js/expert/solo/headerExpert.js"></script>
