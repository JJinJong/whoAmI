...
<c:set var="userStatus" value="${userStatus}"/>
            ...
            <div class="BackTitle__BackTitleWrapper-sc-13svaxc-3 kNfuaY">
                ...
                <div>
                    <div class="top__title">
                        <div class="BackTitle__TitleDiv-sc-13svaxc-1 goChkk title">사연 작성</div>
                    </div>
                </div>
            </div>
            <form action="${pageContext.request.contextPath}/worry/WorryWriteOk.bo" name="writeForm" method="post" >
            ...
            <div class="write card">
                <div class="header">
                    <div class="select">
                        ...
                        <div class="options">
                                <div class="option">
                                <input class="input_OnOff1" type="hidden" name="worryNickNameCheck" value="0">
                                ...
                                <div class="option">
                                	<input class="input_OnOff2" type="hidden" name="worryReadMeCheck" value="0">
                                    <div class="OnOff__OnOffWrapper-ydco07-0 cbIfjw" name="worryReadMeCheck">
                                        <div class="on-off off">
                                            <div class="switch"></div>
                                        </div>
                        ...
                        <div class="main">
                            <div class="main__title">
                                <input name="worryTitle" class="main__title__input " type="text" placeholder="당신의 고민을 한줄로 요약해 주세요" value>
                            </div>
                            <div class="main__contents">
                                <textarea name="worryContent" class="autosize" placeholder="전문가의 답변을 받기위해 자세하게 작성해주세요" style="height: 34px;"></textarea>
                            </div>
                            <div class="main__hashtag">
                                ...
                                <input name="worryHashTag" class="main__hashtag__tags" type="text" placeholder="해시태그를 남겨보세요 ex) #위로 #응원" value>
                            </div>
                        </div>
                        <div class="footer">
                            <button type="button" onclick="send()">작성완료</button>
                        </div>
                    </div>
                    </form>    
                </div>    
    ...
    <script >
        ...
        // 세부 카테고리
        	...
        	const $input_text = $(".category-text")
        	/* console.log($input); */
    ...
    //send onclick이벤트
    function send(){
 		if(!writeForm.worryContent){
 			alert("사연을 10자 이상 작성해주세요.");
 			return;
 		}
