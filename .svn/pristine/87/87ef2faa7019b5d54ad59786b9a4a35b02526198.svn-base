...
public class TestInfoListOk implements Action{

	@Override
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		System.out.println("들어옴");
		HashMap<String, Integer> testInfoMap = new HashMap<>();
...
//		int total = bDao.getTotal();
		...
		testInfoMap.put("startRow", startRow);
		testInfoMap.put("rowCount", rowCount);
...
//		}
		...
		req.setAttribute("testInfoList", dao.selectAll(testInfoMap));
//		req.setAttribute("boardList", boardDTO_list);
		...
		af.setPath("/app/management/mbti/mbtiList.jsp");
